...
class Player(db.Model):
    ...
    name = db.Column(db.String(20), default="PLAYER")
    ...
    current_team = db.Column(db.String(20), index=True, default="NEUTRAL")
    is_spymaster = db.Column(db.Boolean, index=True, default=False)
